...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Script to convert BraTSC 2023 dataset in the MNI space to be used by AOT-GAN"
    )
    ...
    parser.add_argument(
        ...
        default="/scratch/santorum/data/brats23-mni-dm-inpainting-preprocessed-3d",
    )
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the output BraTSC 2023 dataset (brains) in MNI space after preprocessing",
        default="/scratch/santorum/data/brats23-mni-AOT-GAN-brains-png",
    )
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the output BraTSC 2023 dataset (masks) in MNI space after preprocessing",
        default="/scratch/santorum/data/brats23-mni-AOT-GAN-masks-png",
    )
